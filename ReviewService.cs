...
namespace Client
{
    public partial class ReviewService : Form
    {
        ...
        private async void ReviewService_Load(object sender, EventArgs e)
        {
            _repo = new RReview();

            this.BackColor = System.Drawing.Color.White;

            sql = $"SELECT * FROM УчетПокупокУслуг WHERE НКл = {lbWhoLogged.Text}";
